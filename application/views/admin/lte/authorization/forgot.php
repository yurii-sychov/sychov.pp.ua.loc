...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <p class="mb-1">
                    <a href="/admin/authorization/forgot">I forgot my password</a>
                </p>
                <p class="mb-0">
                    <a href="/admin/authorization/signup" class="text-center">Register a new membership</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
    ...
    <!-- CustomJS -->
    <script src="/assets/admin/js/pages/authorization.js"></script>
