...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="">SP<strong>Repair</strong></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Войдите, что бы начать сеанс</p>
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block btn-flat" id="btnSignin">&#1042;&#1086;&#1081;&#1090;&#1080;</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
                ...
                <p class="mb-1" style="display: none;">
                    <a href="/admin/authorization/forgot">Я забыл свой пароль</a>
                </p>
                <p class="mb-0" style="display: none;">
                    <a href="/admin/authorization/signup" class="text-center">Регистрация нового пользователя</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
    ...
    <!-- CustomJS -->
    <script src="/assets/admin/js/pages/authorization/signin.js"></script>
