				...
				<form id="Form">			
					...
					<div class="form-group">
						...
						<!-- <div class="custom-control custom-switch">
							<input type="checkbox" class="custom-control-input" id="CheckboxStatus" name="status">
							<label class="custom-control-label" for="CheckboxStatus">Show on the main page</label>
						</div> -->
					</div>
					<div class="form-group">
						<div class="icheck-primary d-inline">
					...
					<div class="form-group">
						...
						<textarea cols="30" rows="4" class="form-control" id="TextareaFeedback" placeholder="Enter feedback" name="feedback"></textarea>
					</div>
				</form>
			</div>
